    ...
    copy: {
        ...
        sections: {
            ...
            howToTrackInApp: {
                ...
                step1: {
                    title: 'Step 1: Log each job posting lead',
                    icon: 'work',
                    items: [
                        { text: 'When you find a job posting on LinkedIn, capture the essentials.' },
                        { text: 'Include: job title, job URL, posted_at, applicants_when_found, source (LinkedIn Job vs LinkedIn Post).' },
                        { text: 'Start a Conversation and add those details in the notes so outreach has context.', link: '/conversations' },
                        { text: 'Note anything useful from the posting (hiring manager hints, team, tech stack) directly in that Conversation.' },
                        { text: 'Link to the company if you track it, and reference the company inside the Conversation.', link: '/companies' },
                    ],
                },
                step2: {
                    ...
                    link: { text: 'Go to Contacts page', route: '/contacts' },
                    items: [
                        { text: 'Create or update Contacts for people tied to the posting (hiring managers, recruiters, founders, etc.).', link: '/contacts' },
                        { text: 'Note how they relate to the job posting and tag with "Job Board Lead Sniping".' },
                    ],
                },
                step3: {
                    ...
                    link: { text: 'Go to Conversations page', route: '/conversations' },
                    items: [
                        { text: 'Log each outreach as a Conversation and mention the job posting URL for context.', link: '/conversations' },
                        { text: 'Track which channels you used (dm, email, loom, etc.).' },
                        { text: 'Use the same tag so you can filter results later.' },
                    ],
                },
                step4: {
                    ...
                    link: { text: 'Go to Opportunities page', route: '/opportunities' },
                    items: [
                        { text: 'If the lead advances, create an Opportunity linked to the Contact.', link: '/opportunities' },
                        { text: 'Copy over the job posting notes (URL, posted_at, applicants_when_found, source).' },
                        { text: 'Track the interview stages inside the opportunity.' },
                    ],
                },
                step5: {
                    ...
                    icon: 'filter_list',
                    items: [
                        { text: 'Filter Contacts by the "Job Board Lead Sniping" tag to see all leads.', link: '/contacts' },
                        { text: 'Filter Opportunities by the same tag to measure conversions.', link: '/opportunities' },
                    ],
                },
                tip: {
                    text: 'Pro tip: Keep job URLs and applicant counts close to the Contact/Opportunity so you can prioritize fresh postings quickly.',
                    type: 'info',
                },
            },
        },
