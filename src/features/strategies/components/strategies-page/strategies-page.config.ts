    ...
    copy: {
        ...
        sections: {
            coreIdea: {
                ...
                content: [
                    'Referrals are the #1 fastest way to get interviews.',
                    'Referred candidates are 4–5x more likely to get hired/interviewed.',
                    'Companies are drowning in low-quality, spammy, AI-generated applications → they trust employees more than random resumes.',
                    'Employees often get paid (sometimes $2k–$10k) for successful referrals, so helping you is literally in their interest.',
                    'Your job:',
                    '• Squeeze all possible warm referrals (people you know / are connected to)',
                    '• Then do cold outreach to people at your dream companies',
                    '• Stay organized & follow up like a pro.',
                ],
            },
            warmReferrals: {
...
And if there's any extra info you need from me, I'll send it right away.`,
            ...
            spreadsheetStructure: {
                title: '5. Simple spreadsheet structure (to stay organized)',
                description: 'Make a sheet with columns like:',
                columns: [
                    'Name',
                    'LinkedIn URL',
                    'Company',
                    'Role / Team',
                    'Warm or Cold',
                    'Common Ground (school/city/tech)',
                    'Date 1st Message',
                    'Follow-up 1 date',
                    'Follow-up 2 date',
                    'Follow-up 3 date',
                ...
                note: 'Update this every time you send a message or get a reply. That\'s how you turn this into a repeatable system instead of random DMs.',
            },
            howToTrackInApp: {
                ...
                step1: {
                    ...
                    items: [
                        'Go to the Contacts page (click "Contacts" in the top navigation).',
                        'Click "Create Contact" to add a new person.',
                        'Fill in their basic info: name, LinkedIn URL, company, role.',
                        'In the "Strategy Tracking" section:',
                        '  • Select "SMART Strategy" from the Strategies dropdown',
                        '  • Choose "Warm" or "Cold" based on whether you know them',
                        '  • Add any "Common Ground" (shared school, city, tech stack, etc.)',
                        '  • Set "Contact Type" (e.g., Developer, Manager, Recruiter)',
                    ],
                },
                step2: {
                    title: 'Step 2: Track connection lifecycle',
                    items: [
                        'When you send a connection request, update the contact:',
                        '  • Set "Connection Request Sent At" to today\'s date',
                        '  • Set "Connection Status" to "Request Sent"',
                        'When they accept:',
                        '  • Set "Connection Accepted At" to the acceptance date',
                        '  • Update "Connection Status" to "Connected"',
                        'When you send your first DM:',
                        '  • Set "DM Sent At" to today\'s date',
                        '  • Set "First Message Date" if this is your first outreach',
                    ],
                },
                step3: {
                    title: 'Step 3: Create conversations and track follow-ups',
                    items: [
                        'For each contact, create a Conversation (go to Conversations page or from the contact detail page).',
                        'Paste the message thread from LinkedIn into the conversation.',
                        'In the conversation detail page, you can track:',
                        '  • "Follow-up 1 Date", "Follow-up 2 Date", "Follow-up 3 Date"',
                        '  • Set "Response Received" when they reply',
                        '  • Add notes about the conversation progress',
                    ],
                },
                step4: {
                    ...
                    items: [
                        ...
                        '  • Check "Referral Given"',
                        '  • Set "Referral Given At" to today\'s date',
                        '  • Add details about the referral in "Referral Details"',
                    ],
                },
                step5: {
                    title: 'Step 5: Filter and analyze your progress',
                    items: [
                        'Use the Contacts page filters to:',
                        '  • Filter by "Warm" or "Cold" to see your outreach mix',
                        '  • Filter by "Connection Status" to see who hasn\'t accepted yet',
                        '  • Filter by strategy to see all SMART strategy contacts',
                        'Use the Conversations page to:',
                        '  • See which conversations need follow-ups',
                        '  • Track response rates and engagement',
                    ],
                },
                tip: 'Pro tip: Link contacts to companies (if the company exists in your Companies list) to get a complete view of all your outreach at each target company.',
            },
        },
    },
} as const;
        ...
        sections: {
            whatItIs: {
                ...
                whyItWorks: {
                    title: 'Why it works:',
                    items: [
                        'Fresh funding ⇒ they need to hire engineers soon',
                        'Less competition ⇒ you\'re not 1 of 1,000 applicants',
                        'Startups are more flexible on requirements (years of experience, background)',
                        'Interviews are usually faster, more practical, less LeetCode-heavy',
                    ],
                },
                note: 'This is basically the "Code Vendor job strategy": you find startups right after they raise, then reach out directly to decision-makers instead of sitting on job boards.',
            },
            workflow: {
...
A quick "yes", "no" or "maybe later" would help me a lot so I know where I stand.`,
            ...
            trackingStructure: {
                title: '4. A simple tracking structure (spreadsheet or inside your app)',
                description: 'This fits nicely into your app\'s data model for "outreaches" and "conversations".',
                companyFields: {
                    title: 'For each company:',
                    items: [
                        'company_name',
                        'industry',
                        'funding_round (Seed / Series A / B / etc.)',
                        'funding_date',
                        'source (Crunchbase / article / "growth list" / other)',
                        'careers_page_url',
                        'has_relevant_role (yes/no)',
                        'role_title',
                        'applied (yes/no)',
                        'application_date',
                    ],
                ...
                contactFields: {
                    title: 'For each contact (linked to a company):',
                    items: [
                        'name',
                        'linkedin_url',
                        'role (CTO, recruiter, etc.)',
                        'type (hiring manager / recruiter / founder)',
                        'connection_request_sent_at',
                        'connection_accepted_at',
                        'dm_sent_at',
                        'last_follow_up_at',
                        'status (No response / Talking / Interview scheduled / Closed)',
                        'notes (e.g. what you mentioned, message variant used)',
                    ],
                },
            },
            howToTrackInApp: {
                ...
                step1: {
                    ...
                    items: [
                        'Go to the Companies page (click "Companies" in the top navigation).',
                        'Click "Create Company" for each startup you discover.',
                        'Fill in the funding details:',
                        '  • Company name and industry',
                        '  • Funding round (Seed, Series A, Series B, etc.)',
                        '  • Funding date (when they raised)',
                        '  • Funding source (Crunchbase, article, etc.)',
                        '  • Careers page URL (if they have one)',
                        'Use the filters to find companies by:',
                        '  • Industry',
                        '  • Funding round',
                        '  • Whether they have relevant roles',
                ...
                step2: {
                    ...
                    items: [
                        'When you check their careers page:',
                        '  • Check "Has Relevant Role" if they have a role that fits',
                        '  • Add the "Role Title" if applicable',
                        'When you apply:',
                        '  • Check "Applied"',
                ...
                step3: {
                    ...
                    items: [
                        'For each company, create Contacts for the people you reach out to:',
                        '  • Go to Contacts page → Create Contact',
                        '  • Link the contact to the company (select from Companies dropdown)',
                        '  • Select "Recently Funded Startup" from the Strategies dropdown',
                        '  • Set "Contact Type" (hiring manager, recruiter, founder, etc.)',
                        '  • Add their LinkedIn URL and role',
                    ],
                },
                step4: {
                    title: 'Step 4: Track your outreach',
                    items: [
                        'Create a Conversation for each person you message:',
                        '  • Go to Conversations page or create from the contact detail page',
                        '  • Paste the LinkedIn message thread',
                        '  • Tag the conversation with "Recently Funded Startup" strategy',
                        'Track connection lifecycle on the contact:',
                        '  • Connection Request Sent At',
                ...
                step5: {
                    ...
                    items: [
                        'Use the Pipeline page to see all opportunities grouped by stage.',
                        'Use the Companies page to see which companies you\'ve targeted and their status.',
                        'Filter contacts by strategy to see all your "Recently Funded Startup" outreach.',
                        'Check the Today page for follow-ups and next actions.',
                    ],
                },
                tip: 'Pro tip: Create an Opportunity for each company/role you\'re pursuing. Link it to the contact and tag it with "Recently Funded Startup" strategy to track the full journey from discovery to interview.',
            },
        },
    },
} as const;
...
export const PROOF_OF_WORK_OUTREACH_STRATEGY_CONFIG = {
    copy: {
        ...
        description: 'Stand out by fixing real problems or building with the company\'s own product',
        exampleResult: 'Example result: In ~20 days, this strategy led to 5 interviews and 2 offers (plus more in the pipeline).',
        ...
        sections: {
            ...
            howToTrackInApp: {
                ...
                step1: {
                    ...
                    items: [
                        'Go to the Opportunities page or create from a Contact detail page.',
                        'Create a new Opportunity for the company you\'re targeting.',
                        'Link it to the contact (the person you\'re reaching out to).',
                        'Tag it with "Proof-Of-Work Outreach" strategy.',
                    ],
                },
                step2: {
                    title: 'Step 2: Track your proof-of-work type',
                    items: [
                        'On the Opportunity detail page, find the "Proof-of-Work Tracking" section.',
                        'Select your proof-of-work type:',
                        '  • "Proof of Work - Bugs" (if you found UI/UX issues)',
                        '  • "Proof of Work - Build" (if you built something with their product)',
                        '  • "Other" (for other types of proof-of-work)',
                    ],
                },
                step3: {
                    title: 'Step 3: Document bugs/issues (Flavor A)',
                    items: [
                        'If you found bugs or UX issues:',
                        '  • Click "Add Issue" in the "Issues Found" section',
                        '  • For each issue, add:',
                        '    - Issue description (what the problem is)',
                        '    - Notes (why it matters, suggestions)',
                        '    - Screenshot URL (if you have one)',
                        '  • Add 4–5 high-impact issues',
                    ],
                },
                step4: {
                    title: 'Step 4: Document your build (Flavor B)',
                    items: [
                        'If you built something with their product:',
                        '  • Add "Project Details" describing what you built',
                        '  • Add "Loom Video URL" (your demo video)',
                        '  • Add "GitHub Repository URL" (your code)',
                        '  • Add "Live Demo URL" (deployed project)',
                        '  • Add "Shared Channels" (where you posted: slack, linkedin, discord, etc.)',
                    ],
                },
                step5: {
                    title: 'Step 5: Track team responses',
                    items: [
                        'When team members respond to your work:',
                        '  • Click "Add Team Response"',
                        '  • Add their name, their response, and the date',
                        '  • Track positive reactions, questions, or interview invitations',
                    ],
                },
                step6: {
                    title: 'Step 6: Link to conversations',
                    items: [
                        'Create a Conversation for your outreach:',
                        '  • Go to Conversations page or create from the opportunity',
                        '  • Paste the message thread where you shared your proof-of-work',
                        '  • Tag it with "Proof-Of-Work Outreach" strategy',
                        '  • Track responses and follow-ups in the conversation',
                    ],
                },
                tip: 'Pro tip: Use the Pipeline page to see all your proof-of-work opportunities at a glance. Filter by strategy to focus on this approach.',
            },
        },
    },
} as const;
...
export const LOOM_EMAIL_OUTREACH_STRATEGY_CONFIG = {
    copy: {
        ...
        sections: {
            ...
            whyItWorks: {
                ...
                reasons: [
                    ...
                    },
                    {
                        ...
                        content: 'Founders/CEOs/Eng managers see almost nobody sending personalized videos.\n\nOne CEO\'s reaction to a student\'s Loom video was:\n\n"What a cool way to make an introduction. I\'m reaching out to her immediately."',
                    },
                    {
            ...
            tracking: {
                title: '4. Tracking (so you don\'t fly blind)',
                description: 'Like every strategy, this only really works if you track it.',
                forEachEmail: {
                    title: 'For each email outreach, keep:',
                    items: [
                        'company_name',
                        'contact_name',
                        'role (CTO, Eng Manager, etc.)',
                        'email',
                        'date_sent',
                        'loom_sent (yes/no + link)',
                        'follow_up_dates',
                        'status (No reply / Replied / Call scheduled / Rejected / In process)',
                    ],
                },
                thenYouCanSee: {
                    title: 'Then you can see:',
                    items: [
                        'How many emails → replies → calls → interviews → offers',
                        'Which templates and Loom angles work best',
                        'Where to tweak (subject lines, intros, CTAs, etc.)',
                    ],
                },
            },
            howItFits: {
                title: '5. How it fits into your overall system',
            ...
            howToTrackInApp: {
                ...
                step1: {
                    ...
                    items: [
                        'Go to the Contacts page → Create Contact.',
                        'Add the person\'s email address (use Apollo or similar to find it).',
                        'Tag the contact with "Loom Email Outreach" strategy.',
                        'Set "Contact Type" (CTO, Engineering Manager, Recruiter, etc.).',
                        'Link to their company if it exists in your Companies list.',
                    ],
                },
                step2: {
                    title: 'Step 2: Create a conversation for email tracking',
                    items: [
                        'Create a Conversation for this outreach (channel: "email").',
                        'Tag it with "Loom Email Outreach" strategy.',
                        'On the conversation detail page, find the "Email Tracking" card.',
                    ],
                },
                step3: {
                    ...
                    items: [
                        ...
                        '  • Set "Email Sent At" to today\'s date and time',
                        '  • Add "Loom Video URL" (the link to your video)',
                        '  • Check "Loom Sent" if you included the video in the email',
                        'Set "Email Status" to track progress:',
                        '  • "No Reply" (default)',
                        '  • "Replied" (when they respond)',
                        '  • "Call Scheduled" (when you book a call)',
                        '  • "In Process" (ongoing conversation)',
                ...
                step4: {
                    ...
                    items: [
                        'Add follow-up dates in "Email Follow-up Dates" (click to add multiple dates).',
                        'Or use the individual follow-up fields:',
                        '  • "Follow-up 1 Date" (first bump)',
                        '  • "Follow-up 2 Date" (second bump)',
                        '  • "Follow-up 3 Date" (final follow-up)',
                        'When they respond:',
                        '  • Check "Response Received"',
                        '  • Set "Response Received At" to the response date',
                ...
                step5: {
                    ...
                    items: [
                        'Copy the email exchange from your email client.',
                        'Paste it into the Conversation as messages.',
                        'This keeps your full email history in one place.',
                    ],
                },
                step6: {
                    title: 'Step 6: Monitor and analyze',
                    items: [
                        'Use the Conversations page filters:',
                        '  • Filter by "Email Status" to see who hasn\'t replied',
                        '  • Filter by strategy to see all Loom Email Outreach',
                        'Check the Today page for:',
                        '  • Conversations that need follow-ups',
                        '  • Emails sent that are waiting for responses',
                    ],
                },
                tip: 'Pro tip: Combine this with Proof-of-Work Outreach. Create an Opportunity with your proof-of-work details, then create a Conversation for the email outreach. Link them together to see the full picture.',
            },
        },
    },
} as const;
        ...
        sections: {
            ...
            howToTrackInApp: {
                ...
                step1: {
                    ...
                    items: [
                        'Go to the Job Postings page (click "Job Postings" in the top navigation).',
                        'Click "Create Job Posting" for each job you find.',
                        'Fill in the details:',
                        '  • Job Title',
                        '  • Job URL (the LinkedIn job posting URL)',
                        '  • Posted At (when it was posted, if known)',
                        '  • Applicants When Found (e.g., "0", "<25", "100+")',
                        '  • Source: Select "LinkedIn Job" or "LinkedIn Post"',
                        '  • Link to Company (if the company exists in your Companies list)',
                    ],
                },
                step2: {
                    title: 'Step 2: Track contacts you find',
                    items: [
                        'In the "Contacts Found" field (or notes), list the people you identified:',
                        '  • Hiring managers',
                        '  • Recruiters',
                        '  • Engineering managers',
                        '  • Founders/CTOs',
                        'Or create actual Contact records for each person:',
                        '  • Go to Contacts page → Create Contact',
                        '  • Link them to the company',
                        '  • Tag with "Job Board Lead Sniping" strategy',
                    ],
                },
                step3: {
                    title: 'Step 3: Track your outreach',
                    items: [
                        'When you reach out to people from the job posting:',
                        '  • Check "Outreach Done" on the job posting',
                        '  • Add "Outreach Channels" (e.g., ["dm", "email", "loom"])',
                        'Create Conversations for each outreach:',
                        '  • Tag with "Job Board Lead Sniping" strategy',
                        '  • Reference the job posting in notes',
                    ],
                },
                step4: {
                    title: 'Step 4: Convert to opportunity',
                    items: [
                        'If the job posting leads to a real opportunity:',
                        '  • Create an Opportunity (link to the contact)',
                        '  • Link the job posting to the opportunity',
                        '  • Tag the opportunity with "Job Board Lead Sniping" strategy',
                        '  • Track the full interview process in the opportunity',
                    ],
                },
                step5: {
                    title: 'Step 5: Filter and analyze',
                    items: [
                        'Use the Job Postings page filters:',
                        '  • Filter by "Source" to see LinkedIn Post vs LinkedIn Job',
                        '  • Filter by "Outreach Done" to see which leads you\'ve acted on',
                        'Use the Contacts page:',
                        '  • Filter by "Job Board Lead Sniping" strategy',
                        '  • See all people you found through job postings',
                    ],
                },
                tip: 'Pro tip: Use the Job Postings page to quickly see which fresh postings you haven\'t acted on yet. Sort by "Posted At" to prioritize the newest leads.',
            },
        },
    },
} as const;
        ...
        sections: {
            ...
            howToTrackInApp: {
                ...
                step1: {
                    ...
                    items: [
                        'Go to the Challenges page (click "Challenges" in the top navigation).',
                        'Click "Create Challenge".',
                        'Set up your challenge:',
                        '  • Name: "100-Connection Week" (or your custom name)',
                        '  • Start Date: First day of your challenge week',
                        '  • End Date: Last day of your challenge week',
                        '  • Goal: 100 (or your target number)',
                        '  • Initial metrics: Set all to 0',
                    ],
                },
                step2: {
                    title: 'Step 2: Track outreaches as you go',
                    items: [
                        'For each person you reach out to:',
                        '  • Create a Contact (go to Contacts page)',
                        '  • Tag the contact with "The 100-Connection Week" strategy',
                        '  • Link the contact to your challenge (this will be tracked automatically)',
                        'Update the challenge metrics weekly:',
                        '  • "Outreaches Count": Total connection requests sent',
                        '  • "Accepts Count": How many accepted your request',
                        '  • "Replies Count": How many replied to your DMs',
                        '  • "Calls Count": How many calls/interviews scheduled',
                        '  • "Interviews Count": How many actual interviews',
                    ],
                },
                step3: {
                    title: 'Step 3: Track conversations and follow-ups',
                    items: [
                        'Create Conversations for each person who accepts:',
                        '  • Tag with "The 100-Connection Week" strategy',
                        '  • Paste the message thread',
                        '  • Track follow-up dates (Follow-up 1, 2, 3)',
                        '  • Mark "Response Received" when they reply',
                    ],
                },
                step4: {
                    ...
                    items: [
                        ...
                        '  • Metrics show your conversion funnel',
                        'Use the Contacts page:',
                        '  • Filter by "The 100-Connection Week" strategy',
                        '  • See all contacts from your challenge',
                        '  • Filter by connection status to see who hasn\'t accepted',
                    ],
                },
                step5: {
                    title: 'Step 5: Convert to opportunities',
                    items: [
                        'When conversations turn into real opportunities:',
                        '  • Create an Opportunity (link to the contact)',
                        '  • Tag with "The 100-Connection Week" strategy',
                        '  • Track the interview process',
                        'Update challenge metrics:',
                        '  • Increment "Calls Count" when calls are scheduled',
                        '  • Increment "Interviews Count" for actual interviews',
                    ],
                },
                step6: {
                    title: 'Step 6: Weekly recap',
                    items: [
                        'At the end of the week, update your challenge:',
                        '  • Review all metrics',
                ...
                tip: 'Pro tip: Use the Today page to see your daily action items. Focus on hitting your daily outreach target (e.g., ~14 outreaches per day for 100 in a week).',
            },
        },
    },
} as const;
